...
$('#baID').on('keydown', function(e) {
    ...
    else if ( (evt.ctrlKey || evt.metaKey) && evt.altKey && evt.shiftKey && evt.keyCode == 84 /*'U'*/ )     {   insertAtCursor(crt, "Ṭ");   } 
    else if ( (evt.ctrlKey || evt.metaKey) && evt.altKey && evt.keyCode == 84 /*'u'*/ )                     {   insertAtCursor(crt, "ṭ");   } 
